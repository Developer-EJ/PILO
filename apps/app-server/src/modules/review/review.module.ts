...
import { ReviewArtifactsRepository } from "./artifacts/review-artifacts.repository";
import { ReviewArtifactsService } from "./artifacts/review-artifacts.service";
import { RuntimeReviewArtifactsRepository } from "./artifacts/runtime-review-artifacts.repository";
...
import { CodeReviewRoomRepository } from "./room/code-review-room.repository";
...
import { RuntimeCodeReviewRoomRepository } from "./room/runtime-code-review-room.repository";
...
@Module({
  ...
  providers: [
    ...
    {
      provide: CodeReviewRoomRepository,
      useClass: RuntimeCodeReviewRoomRepository,
    },
    {
    ...
    {
      provide: ReviewArtifactsRepository,
      useClass: RuntimeReviewArtifactsRepository,
    },
