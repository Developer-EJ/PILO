...
assert.match(meetingTypes, /MeetingReportActionItemCalendarEvent/);
assert.match(meetingTypes, /CreateMeetingReportActionItemCalendarEventInput/);
...
assert.match(meetingApiClient, /createMeetingReportActionItemCalendarEvent/);
assert.match(meetingApiClient, /\/calendar-events/);
...
assert.match(meetingReportSection, /createMeetingReportActionItemCalendarEvent/);
assert.match(meetingReportSection, /onCreateActionItemCalendarEvent/);
assert.match(meetingReportSection, /후속 작업으로 돌아가기/);
assert.match(meetingReportSection, /일정 생성됨/);
...
assert.match(meetingReportSection, /approveMeetingReportActionItem/);
