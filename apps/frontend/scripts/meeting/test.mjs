...
assert.match(meetingPanel, /LOCATION_CHANGE_EVENT/);
assert.match(meetingPanel, /window\.history\.pushState/);
assert.match(meetingPanel, /window\.history\.replaceState/);
