...
export const piloStickyNoteColors = [
  ...
  { value: "peach", label: "피치", fill: "#ffbb78", border: "#df8240" },
  ...
  { value: "sky", label: "스카이", fill: "#a9c9f7", border: "#6c9ad9" },
  { value: "violet", label: "바이올렛", fill: "#aaa1ef", border: "#7c6ed9" },
  { value: "cyan", label: "시안", fill: "#8edcf0", border: "#4caecb" },
  { value: "blue", label: "블루", fill: "#82aef0", border: "#4d7ed2" },
  { value: "mint", label: "민트", fill: "#78d8cf", border: "#45aaa0" },
  { value: "green", label: "그린", fill: "#67d886", border: "#3aa65b" },
  { value: "lime", label: "라임", fill: "#cbeca0", border: "#93bf52" },
  { value: "grass", label: "잔디", fill: "#aee755", border: "#7eba28" },
  { value: "white", label: "화이트", fill: "#f4f5f7", border: "#c7ccd5" },
  { value: "black", label: "블랙", fill: "#171717", border: "#050505" },
] as const;
