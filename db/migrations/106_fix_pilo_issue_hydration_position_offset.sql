CREATE OR REPLACE FUNCTION public.refresh_pilo_issues_from_github(
  p_board_id BIGINT
)
RETURNS VOID AS $$
BEGIN
  PERFORM pg_advisory_xact_lock(
    hashtextextended('refresh_pilo_issues_from_github:' || p_board_id::text, 0)
  );
