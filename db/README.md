...
- `migrations/052_add_meeting_report_action_item_calendar_link.sql` adds the nullable one-to-one Calendar event link, link audit fields, delete-safe FK behavior, and supporting audit-user index for approved Meeting action items.
