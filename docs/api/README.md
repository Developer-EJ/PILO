...
| [board-api.md](board-api.md) | GitHub Project Kanban 보드 캐시와 읽기 전용 보드 화면 API |
...
- GitHub 원본 조회와 동기화는 GitHub App installation token을 사용한다.
...
- MVP 제외: GitHub issue write API, PR merge/close, GitHub inline review comment, ProjectV2 write API, 캘린더 반복/알림/외부 연동, MeetingRoom 관리, 자유형 캔버스 실시간 협업.
