...
| `GET` | `/workspaces/:workspaceId/canvas/boards/:boardId` | board + shapes + connections 조회 |
| `POST` | `/workspaces/:workspaceId/canvas/boards/:boardId/shapes` | shape 생성 |
| `PATCH` | `/workspaces/:workspaceId/canvas/shapes/:shapeId` | shape 표시 속성 수정 |
| `PUT` | `/workspaces/:workspaceId/canvas/shapes/:shapeId/position` | shape 위치 저장 |
| `DELETE` | `/workspaces/:workspaceId/canvas/shapes/:shapeId` | shape 제거 |
| `POST` | `/workspaces/:workspaceId/canvas/boards/:boardId/connections` | shape 연결 생성 |
| `DELETE` | `/workspaces/:workspaceId/canvas/connections/:connectionId` | 연결 제거 |
| `PUT` | `/workspaces/:workspaceId/canvas/boards/:boardId/view-settings` | zoom/viewport 저장 |
| `PUT` | `/workspaces/:workspaceId/canvas/boards/:boardId/filter-settings` | filter 저장 |
