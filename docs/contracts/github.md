...
| `GET` | `/workspaces/:workspaceId/github/issues` | GitHub issue summary list for workspace consumers |
| `GET` | `/workspaces/:workspaceId/github/pull-requests` | Paginated GitHub PR summary list for workspace consumers |
