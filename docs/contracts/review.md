...
| `POST` | `/pull-requests/:pullRequestId/review-room` | Create or return a code review room for a PR |
| `GET` | `/code-review-rooms/:roomId` | Read a code review room summary |
| `POST` | `/pull-requests/:pullRequestId/analysis` | Request PR analysis and create/read the pending analysis root |
| `GET` | `/pull-requests/:pullRequestId/analysis` | Read the current PR analysis root |
| `GET` | `/pull-request-analyses/:analysisId/graph` | Read the AI-generated review graph |
| `GET` | `/pull-request-analyses/:analysisId/canvas` | Canvas alias for the AI review workflow screen |
| `PATCH` | `/review-nodes/:nodeId/state` | Upsert a reviewer state for one review node |
| `POST` | `/code-review-rooms/:roomId/comments` | Create a human review comment |
| `POST` | `/pull-request-analyses/:analysisId/checklist-items` | Create or upsert a review checklist item |
