...
| Task -> PR -> Review | 주형 GitHub / 은재 Review | 동현/주형/은재 | `PullRequestSummary`, `PullRequestChangedFileSummary`, `PRAnalysisSummary` | 주형은 PR 원본과 changed file source, 은재는 분석 결과를 소유한다 |
