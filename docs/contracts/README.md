...
| 주형 | `task.md`, `github.md`, `progress.md` | TaskSummary, TaskDraft, MilestoneSummary, GithubConnectionSummary, GithubRepositorySummary, GithubIssueSummary, PullRequestSummary, ProgressSummary |
