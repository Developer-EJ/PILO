...
| 진호 | `meeting.md`, `voice.md` | MeetingAgenda, MeetingReportSummary, MeetingDecisionSummary, MeetingReportRiskSummary, MeetingReportNextAgenda, MeetingReportCanvasEntityRef, MeetingActionItem, MeetingActionItemTaskDraftResponse, VoiceScaffoldResponse, VoiceRoom, VoiceSession |
